...
export declare function createSettingsServer<T extends TwirpContext = TwirpContext>(service: SettingsTwirp<T>): TwirpServer<SettingsTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse<import("http").IncomingMessage>>>, T>;
