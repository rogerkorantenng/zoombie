...
function createBasePermissions() {
    return { requestedFetchDomains: [], asUserScopes: [] };
}
export const Permissions = {
    $type: "devvit.runtime.Permissions",
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.requestedFetchDomains) {
            writer.uint32(10).string(v);
        }
        writer.uint32(18).fork();
        for (const v of message.asUserScopes) {
            writer.int32(v);
        }
        writer.ldelim();
        return writer;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.requestedFetchDomains.push(reader.string());
                    continue;
                case 2:
                    if (tag === 16) {
                        message.asUserScopes.push(reader.int32());
                        continue;
                    }
                    if (tag === 18) {
    ...
    fromJSON(object) {
        return {
            requestedFetchDomains: globalThis.Array.isArray(object?.requestedFetchDomains)
                ? object.requestedFetchDomains.map((e) => globalThis.String(e))
                : [],
            asUserScopes: globalThis.Array.isArray(object?.asUserScopes)
                ? object.asUserScopes.map((e) => scopeFromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.requestedFetchDomains?.length) {
            obj.requestedFetchDomains = message.requestedFetchDomains;
        }
        if (message.asUserScopes?.length) {
            obj.asUserScopes = message.asUserScopes.map((e) => scopeToJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        const message = createBasePermissions();
        message.requestedFetchDomains = object.requestedFetchDomains?.map((e) => e) || [];
        message.asUserScopes = object.asUserScopes?.map((e) => e) || [];
        return message;
    },
};
...
function createBaseDependencySpec() {
    return { actor: undefined, hostname: "", provides: [], uses: [], permissions: [] };
}
export const DependencySpec = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.permissions) {
            Permissions.encode(v, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            permissions: globalThis.Array.isArray(object?.permissions)
                ? object.permissions.map((e) => Permissions.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.permissions?.length) {
            obj.permissions = message.permissions.map((e) => Permissions.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
export const LinkedBundle = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.server !== undefined) {
            ServerBundle.encode(message.server, writer.uint32(98).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
function createBaseServerBundle() {
...
export const ServerBundle = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.sourceMap !== "") {
            writer.uint32(18).string(message.sourceMap);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseServerBundle();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    message.sourceMap = reader.string();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            code: isSet(object.code) ? globalThis.String(object.code) : "",
            sourceMap: isSet(object.sourceMap) ? globalThis.String(object.sourceMap) : "",
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return ServerBundle.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseServerBundle();
        message.code = object.code ?? "";
        message.sourceMap = object.sourceMap ?? "";
        return message;
    },
};
messageTypeRegistry.set(ServerBundle.$type, ServerBundle);
