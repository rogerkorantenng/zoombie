...
import { AppVersionInfo, AppVersionMarketingInfo, computePoolFromJSON, computePoolToJSON, installationTypeFromJSON, installationTypeToJSON, OptionalVersionVisibility, versionVisibilityFromJSON, versionVisibilityToJSON, } from "./info/app_version_info.js";
function createBaseAppVersionCreationRequest() {
    return {
        ...
        actorBundles: [],
        about: "",
        preventPlaytestSubredditCreation: false,
        marketingInfo: undefined,
        devvitJson: undefined,
    };
}
export const AppVersionCreationRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.preventPlaytestSubredditCreation !== false) {
            writer.uint32(80).bool(message.preventPlaytestSubredditCreation);
        }
        if (message.marketingInfo !== undefined) {
            AppVersionMarketingInfo.encode(message.marketingInfo, writer.uint32(90).fork()).ldelim();
        }
        if (message.devvitJson !== undefined) {
            writer.uint32(98).string(message.devvitJson);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10:
                    ...
                    message.preventPlaytestSubredditCreation = reader.bool();
                    continue;
                case 11:
                    if (tag !== 90) {
                        break;
                ...
                case 12:
                    ...
                    message.devvitJson = reader.string();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            preventPlaytestSubredditCreation: isSet(object.preventPlaytestSubredditCreation)
                ? globalThis.Boolean(object.preventPlaytestSubredditCreation)
                : false,
            marketingInfo: isSet(object.marketingInfo) ? AppVersionMarketingInfo.fromJSON(object.marketingInfo) : undefined,
            devvitJson: isSet(object.devvitJson) ? globalThis.String(object.devvitJson) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.preventPlaytestSubredditCreation !== false) {
            obj.preventPlaytestSubredditCreation = message.preventPlaytestSubredditCreation;
        }
        if (message.marketingInfo !== undefined) {
            obj.marketingInfo = AppVersionMarketingInfo.toJSON(message.marketingInfo);
        }
        if (message.devvitJson !== undefined) {
            obj.devvitJson = message.devvitJson;
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.preventPlaytestSubredditCreation = object.preventPlaytestSubredditCreation ?? false;
        message.marketingInfo = (object.marketingInfo !== undefined && object.marketingInfo !== null)
            ...
            : undefined;
        message.devvitJson = object.devvitJson ?? undefined;
        return message;
    },
};
