...
export interface DataApiAdminClient {
    ...
    CreateResearchOrganization(request: CreateResearchOrganizationRequest): Promise<CreateResearchOrganizationResponse>;
    GetResearchOrganizations(request: GetResearchOrganizationsRequest): Promise<GetResearchOrganizationsResponse>;
    UpdateResearchOrganization(request: UpdateResearchOrganizationByIdRequest): Promise<UpdateResearchOrganizationResponse>;
    GetResearchOrganization(request: GetResearchOrganizationByIdRequest): Promise<GetResearchOrganizationByIdResponse>;
    DeleteResearchOrganization(request: DeleteResearchOrganizationRequest): Promise<DeleteResearchOrganizationResponse>;
    CreateResearcher(request: CreateResearcherRequest): Promise<CreateResearcherResponse>;
    GetResearchers(request: GetResearchersRequest): Promise<GetResearchersResponse>;
    GetResearcher(request: GetResearcherByIdRequest): Promise<GetResearcherByIdResponse>;
    GetResearchersByOrganizationId(request: GetResearchersByOrganizationIdRequest): Promise<GetResearchersByOrganizationIdResponse>;
    DeleteResearcher(request: DeleteResearcherRequest): Promise<DeleteResearcherResponse>;
}
