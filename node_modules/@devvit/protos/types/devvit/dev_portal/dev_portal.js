...
export class DataApiAdminClientImpl {
    constructor(rpc, opts) {
        ...
        this.CreateResearchOrganization = this.CreateResearchOrganization.bind(this);
        this.GetResearchOrganizations = this.GetResearchOrganizations.bind(this);
        this.UpdateResearchOrganization = this.UpdateResearchOrganization.bind(this);
        this.GetResearchOrganization = this.GetResearchOrganization.bind(this);
        this.DeleteResearchOrganization = this.DeleteResearchOrganization.bind(this);
        this.CreateResearcher = this.CreateResearcher.bind(this);
        this.GetResearchers = this.GetResearchers.bind(this);
        this.GetResearcher = this.GetResearcher.bind(this);
        this.GetResearchersByOrganizationId = this.GetResearchersByOrganizationId.bind(this);
    ...
    CreateResearchOrganization(request, metadata) {
        const data = CreateResearchOrganizationRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "CreateResearchOrganization", data, metadata);
        return promise.then((data) => CreateResearchOrganizationResponse.decode(_m0.Reader.create(data)));
    }
    GetResearchOrganizations(request, metadata) {
        const data = GetResearchOrganizationsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetResearchOrganizations", data, metadata);
        return promise.then((data) => GetResearchOrganizationsResponse.decode(_m0.Reader.create(data)));
    }
    UpdateResearchOrganization(request, metadata) {
        const data = UpdateResearchOrganizationByIdRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateResearchOrganization", data, metadata);
        return promise.then((data) => UpdateResearchOrganizationResponse.decode(_m0.Reader.create(data)));
    }
    GetResearchOrganization(request, metadata) {
        const data = GetResearchOrganizationByIdRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetResearchOrganization", data, metadata);
        return promise.then((data) => GetResearchOrganizationByIdResponse.decode(_m0.Reader.create(data)));
    }
    DeleteResearchOrganization(request, metadata) {
        const data = DeleteResearchOrganizationRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "DeleteResearchOrganization", data, metadata);
        return promise.then((data) => DeleteResearchOrganizationResponse.decode(_m0.Reader.create(data)));
    }
    CreateResearcher(request, metadata) {
        const data = CreateResearcherRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "CreateResearcher", data, metadata);
        return promise.then((data) => CreateResearcherResponse.decode(_m0.Reader.create(data)));
    }
    GetResearchers(request, metadata) {
        const data = GetResearchersRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetResearchers", data, metadata);
        return promise.then((data) => GetResearchersResponse.decode(_m0.Reader.create(data)));
    }
    GetResearcher(request, metadata) {
        const data = GetResearcherByIdRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetResearcher", data, metadata);
        return promise.then((data) => GetResearcherByIdResponse.decode(_m0.Reader.create(data)));
    }
    GetResearchersByOrganizationId(request, metadata) {
        const data = GetResearchersByOrganizationIdRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetResearchersByOrganizationId", data, metadata);
        return promise.then((data) => GetResearchersByOrganizationIdResponse.decode(_m0.Reader.create(data)));
    }
    DeleteResearcher(request, metadata) {
        const data = DeleteResearcherRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "DeleteResearcher", data, metadata);
        return promise.then((data) => DeleteResearcherResponse.decode(_m0.Reader.create(data)));
    }
}
export const DataApiAdminDefinition = {
    ...
    methods: {
        ...
        createResearchOrganization: {
            name: "CreateResearchOrganization",
            requestType: CreateResearchOrganizationRequest,
            requestStream: false,
            responseType: CreateResearchOrganizationResponse,
            responseStream: false,
            options: {},
        },
        getResearchOrganizations: {
            name: "GetResearchOrganizations",
            requestType: GetResearchOrganizationsRequest,
            requestStream: false,
            responseType: GetResearchOrganizationsResponse,
            responseStream: false,
            options: {},
        },
        updateResearchOrganization: {
            name: "UpdateResearchOrganization",
            requestType: UpdateResearchOrganizationByIdRequest,
            requestStream: false,
            responseType: UpdateResearchOrganizationResponse,
            responseStream: false,
            options: {},
        },
        getResearchOrganization: {
            name: "GetResearchOrganization",
            requestType: GetResearchOrganizationByIdRequest,
            requestStream: false,
            responseType: GetResearchOrganizationByIdResponse,
            responseStream: false,
            options: {},
        },
        deleteResearchOrganization: {
            name: "DeleteResearchOrganization",
            requestType: DeleteResearchOrganizationRequest,
            requestStream: false,
            responseType: DeleteResearchOrganizationResponse,
            responseStream: false,
            options: {},
        },
        ...
        createResearcher: {
            ...
            requestType: CreateResearcherRequest,
            requestStream: false,
            responseType: CreateResearcherResponse,
            responseStream: false,
            options: {},
        },
        getResearchers: {
            name: "GetResearchers",
            requestType: GetResearchersRequest,
            requestStream: false,
            responseType: GetResearchersResponse,
            responseStream: false,
            options: {},
        },
        getResearcher: {
            name: "GetResearcher",
            requestType: GetResearcherByIdRequest,
            requestStream: false,
            responseType: GetResearcherByIdResponse,
            responseStream: false,
            options: {},
        },
        getResearchersByOrganizationId: {
            name: "GetResearchersByOrganizationId",
            requestType: GetResearchersByOrganizationIdRequest,
            requestStream: false,
            responseType: GetResearchersByOrganizationIdResponse,
            responseStream: false,
            options: {},
        },
        deleteResearcher: {
            name: "DeleteResearcher",
            requestType: DeleteResearcherRequest,
            requestStream: false,
            responseType: DeleteResearcherResponse,
            responseStream: false,
            options: {},
        },
    },
