...
export declare function createDevPortalAuthorizationServer<T extends TwirpContext = TwirpContext>(service: DevPortalAuthorizationTwirp<T>): TwirpServer<DevPortalAuthorizationTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse<import("http").IncomingMessage>>>, T>;
