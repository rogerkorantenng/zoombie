...
export interface DataApiAdminTwirp<T extends TwirpContext = TwirpContext> {
    ...
    CreateResearchOrganization(ctx: T, request: CreateResearchOrganizationRequest): Promise<CreateResearchOrganizationResponse>;
    GetResearchOrganizations(ctx: T, request: GetResearchOrganizationsRequest): Promise<GetResearchOrganizationsResponse>;
    UpdateResearchOrganization(ctx: T, request: UpdateResearchOrganizationByIdRequest): Promise<UpdateResearchOrganizationResponse>;
    GetResearchOrganization(ctx: T, request: GetResearchOrganizationByIdRequest): Promise<GetResearchOrganizationByIdResponse>;
    DeleteResearchOrganization(ctx: T, request: DeleteResearchOrganizationRequest): Promise<DeleteResearchOrganizationResponse>;
    CreateResearcher(ctx: T, request: CreateResearcherRequest): Promise<CreateResearcherResponse>;
    GetResearchers(ctx: T, request: GetResearchersRequest): Promise<GetResearchersResponse>;
    GetResearcher(ctx: T, request: GetResearcherByIdRequest): Promise<GetResearcherByIdResponse>;
    GetResearchersByOrganizationId(ctx: T, request: GetResearchersByOrganizationIdRequest): Promise<GetResearchersByOrganizationIdResponse>;
    DeleteResearcher(ctx: T, request: DeleteResearcherRequest): Promise<DeleteResearcherResponse>;
}
export declare enum DataApiAdminMethod {
    ...
    CreateResearchOrganization = "CreateResearchOrganization",
    GetResearchOrganizations = "GetResearchOrganizations",
    UpdateResearchOrganization = "UpdateResearchOrganization",
    GetResearchOrganization = "GetResearchOrganization",
    DeleteResearchOrganization = "DeleteResearchOrganization",
    CreateResearcher = "CreateResearcher",
    GetResearchers = "GetResearchers",
    GetResearcher = "GetResearcher",
    GetResearchersByOrganizationId = "GetResearchersByOrganizationId",
